...
<template>
    <div class="text-sm">
        ...
        <div class="mt-2">
            <p>
                We hebben de inschrijving van {{ props.command.firstname }} {{ props.command.lastname }} aangepast.
        ...
        <div class="mt-4">
            <div v-if="props.command.type !== SubscriptionTypeEnum.RENEWAL_LICENSE">
                &mdash; Lidgeld :
            ...
            <div v-if="props.command.type !== SubscriptionTypeEnum.RENEWAL_MEMBERSHIP">
                &mdash; Vergunning:
