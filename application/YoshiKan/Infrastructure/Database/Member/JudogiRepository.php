...
final class JudogiRepository extends ServiceEntityRepository implements \App\YoshiKan\Domain\Model\Member\JudogiRepository
{
    ...
    {
        parent::__construct($registry, Judogi::class);
    }
